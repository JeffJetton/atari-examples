...
> **Note:** The difference between specifying a direct *value* for an operation and specifying an *address* for an operation is important thing to remember! And you probably *will* mostly remember it but still make the mistake anyway an embarrassingly large number of times, leading to more frustrating bugs that you’ll want to admit. Join the club.
